-- ============================================================
-- schema.sql — Creation des tables de la base de donnees SGC
...
CREATE TABLE IF NOT EXISTS ventes (
    ...
    montant_reste   DECIMAL(12, 2) NOT NULL DEFAULT 0.00,
    statut          ENUM('en_cours','payee','partielle','annulee')
...
CREATE TABLE IF NOT EXISTS ventes_details (
    ...
    FOREIGN KEY (vente_id)
        REFERENCES ventes(id)   ON DELETE CASCADE,
