...
('Informatique',    'Ordinateurs, accessoires et périphériques'),
...
('Armoire à rideaux',          'MOB-003',  4, 'Armoire 90x130cm, gris',                55000,  95000,  4,   1,  'pièce'),
('Télévision 55" Samsung',     'ELEC-001', 5, 'TV 4K UHD Smart TV 55 pouces',          200000, 320000,  4,   1,  'pièce'),
...
('KONÉ',       'Aïssatou',      '+225 07 22 33 44', 'aissatou.kone@email.ci', 'Marcory Zone 4',                 'Abidjan'),
...
('COULIBALY',  'Mariam',        '+225 05 66 77 88', 'mariam.c@email.ci',      'San-Pédro Port',                 'San-Pédro'),
('DOUMBIA',    'Séydou',        '+225 01 99 00 11', 'seydou.d@email.ci',      'Daloa Mairie',                   'Daloa'),
...
(1, 1, 1, 350000), (1, 4, 1, 14000), (1, 5, 1, 11000), (1, 3, 2, 5000),
(2, 6, 1, 650000),
(3, 7, 1, 260000), (3, 8, 2, 4000), (3, 9, 1, 9000),
(4, 14, 1, 150000), (4, 15, 1, 80000), (4, 10, 1, 4000),
(5, 10, 10, 4000), (5, 11, 5, 2500), (5, 12, 5, 3000), (5, 13, 5, 1800),
(6, 17, 1, 320000),
(7, 2, 1, 520000), (7, 3, 2, 5000), (7, 19, 2, 10000);

-- ── Mouvements de stock initiaux ──────────────────────────────
INSERT INTO mouvements_stock (produit_id, type_mouvement, quantite, stock_avant, stock_apres, motif, user_id) VALUES
